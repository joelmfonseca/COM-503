...
def plot_prediction(target, prediction, residuals, num_obs=168):
    ...
    def get_preds_and_cis(residuals, predictions, num_obs):
        ...
        return predictions[:num_obs], confidence_intervals
    ...
    predictions, confidence_intervals = get_preds_and_cis(residuals, prediction, num_obs)
